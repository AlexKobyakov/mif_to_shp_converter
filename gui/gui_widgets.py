...
class HeaderWidget(QFrame):
    ...
    def setupUi(self):
        ...
        self.right_panel.setMinimumWidth(300)  # Увеличиваем минимальную ширину
        right_layout = QVBoxLayout(self.right_panel)
        right_layout.setContentsMargins(0, 0, 0, 0)
        right_layout.setSpacing(8)  # Увеличиваем расстояние между строками
        ...
        lang_label = QLabel("🌐")
        lang_label.setStyleSheet("color: white; font-size: 12px; background: transparent;")
        
        self.language_combo = QComboBox()
        self.language_combo.setMaximumWidth(120)  # Ограничиваем ширину
        ...
        right_buttons_layout.setSpacing(8)  # Увеличиваем расстояние между кнопками
        ...
        self.donation_button.setStyleSheet("""
            ...
            QPushButton:hover {
                ...
                transform: scale(1.05);  /* Уменьшаем эффект */
            }
        """)
        self.donation_button.setFixedSize(24, 24)  # Уменьшаем размер
        ...
        """)
        self.author_button.setFixedSize(24, 24)  # Уменьшаем размер
