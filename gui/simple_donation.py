...
class SimpleDonationDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("☕ Поддержка разработки")
    ...
    def setupUi(self):
        ...
        # Заголовок
        title = QLabel("☕ Поддержите разработку плагина")
        title.setStyleSheet("""
            QLabel {
                color: #2c3e50;
                font-size: 18px;
        ...
        # Ko-fi кнопка
        kofi_button = QPushButton("☕ Купить кофе на Ko-fi")
        ...
        # PayPal кнопка
        paypal_button = QPushButton("💳 Пожертвовать через PayPal")
        ...
        github_button = QPushButton("💖 Спонсировать на GitHub")
        ...
        # Кнопка закрытия
        close_button = QPushButton("✅ Может быть позже")
